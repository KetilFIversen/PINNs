...
class PhysicsInformedNN:
    ...
    def train(self, nIter):
        tf_dict = {self.x_f_tf: self.x_f, self.t_f_tf: self.t_f, self.x_u_tf: self.x_u, self.t_u_tf: self.t_u, self.u_tf: self.u}
        ...
        for it in range(nIter):
            ...
            if it % 100 == 0:
                ...
                print('ADAM It: %d, Loss: %.3e, Lambda_1: %.3f, Lambda_2: %.6f, Time: %.2f' % 
